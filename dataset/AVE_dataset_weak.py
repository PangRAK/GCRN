...
class AVEDataset(Dataset):
    def __init__(self, data_root, split='train'):
        ...
        self.split = split
        pdb.set_trace()
        self.visual_feature_path = os.path.join(data_root, 'CFT_visual_features.h5')
        self.audio_feature_path = os.path.join(data_root, 'CFT_audio_features.h5')
        ...
        self.sample_order_path = os.path.join(data_root, f'data_order.h5')
